 ...
 * Google Sign-In (incl. Google for Work / GApps for domain) (documented [here](https://github.com/kakao/docker_auth/blob/master/examples/reference.yml))
 * LDAP bind
...
See the [example config files](https://github.com/kakao/docker_auth/tree/master/examples/) to get an idea of what is possible.
