...
import (
	...
	"github.com/kakao/docker_auth/auth_server/authn"
	"github.com/kakao/docker_auth/auth_server/authz"
)
...
func NewAuthServer(c *Config) (*AuthServer, error) {
	...
	if c.ACLD2Hub != nil {
		d2hubAuthorizer, err := authz.NewACLD2hubAuthorizer(c.ACLD2Hub)
		if err != nil {
			return nil, err
		}
		as.authorizers = append(as.authorizers, d2hubAuthorizer)
	}
	if c.ACLMongo != nil {
	...
	if c.D2hubAuth != nil {
		da, err := authn.NewD2hubAuth(c.D2hubAuth)
		if err != nil {
			return nil, err
		}
